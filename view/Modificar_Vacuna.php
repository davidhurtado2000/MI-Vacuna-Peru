...
if ($_SESSION["usuario"] == "" && $_SESSION["contraseña"] == "") {
    ...
    && isset($_POST["lote"]) && isset($_POST["nombre"])) {
        ...
        $listarIDCentro = $objCentro->ControlleObtenerIDCentroMedicos($nombre);
                            ...
                            <div class="col-md-12 px-4 h-100 border border-dark rounded-0 overflow-auto"
                                ...
                                <div class="container">
                                    <div class="row align-items-center mx-2 my-4">
                                        ...
                                        <form action="../controller/ControllerModificarVacuna.php" method="post">

                                            <?php foreach ($listarDatosPaciente as $filaDatosPaciente) { ?>

                                                <div
                                                    class='row align-items-center mx-2 my-4 border border-3 border-dark overflow-auto'>
                                                    <div class='row my-2 '>
                                                        <div
                                                            class="col-md-12  d-flex justify-content-center align-items-center my-2">
                                                            <?php echo "<label> <strong>Acualizacion de Vacuna para el paciente: </strong>" . $filaDatosPaciente['apellido_p'] . " " . $filaDatosPaciente['apellido_m'] . "
                                                    ...
                                                    <form action="../controller/ControllerModificarVacuna.php" method="post">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="id_tipovacuna" class="col-sm-4 col-form-label ">Selecciona
                                                                Vacuna:
                                                            </label>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="number" value="<?php echo $dosis ?>"
                                                                    class="form form-control-sm  border border-dark"
                                                        ...
                                                        <div
                                                            class="container d-flex justify-content-center align-items-center my-2">
                                                            <div class="btn-group-vertical pt-2" style="background-color: white;">
                                                                <?php foreach ($listarDatosPaciente as $filaDatosPaciente) { ?>
                                                                    <input type="hidden"
                                                                        value="<?php echo $filaDatosPaciente["id_paciente"] ?>"
                                                                        name="id_paciente">
                                                                <?php } ?>
                                                                <?php foreach ($listarIDVacuna as $IDVacuna) { ?>
                                                                    <input type="hidden"
                                                                        value="<?php echo $IDVacuna["id_tipovacuna"] ?>"
                                                                        name="t_vacuna_id_tipovacunaTMP">
                                                                <?php } ?>
                                                                <?php foreach ($listarIDCentro as $IDCentro) { ?>
                                                                    <input type="hidden"
