            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="btn-group-vertical " style="width: 100%; background-color:white;">
                        ...
                        <div type="button" class="btn change-bgcolor border border-dark rounded-0 py-4" href="#">
                            <img src="../img/historial_icon.png" alt="Responsive image" id="menu_logo" class="float-start">
                            <p class="text-wrap">Historial de Vacunas</p>
                        </div>
                        <div type="button" class="btn change-bgcolor border border-dark rounded-0 py-4">
                            <img src="../img/pendiente_icon.png" alt="Responsive image" id="menu_logo" class="float-start">
                            <p class="text-wrap">Vacunas Pendientes</p>
                            
                        </div>
                        <div type="button" class="btn change-bgcolor border border-dark rounded-0 py-4">
                            <img src="../img/buscador_icon.png" alt="Responsive image" id="menu_logo" class="float-start">
                            <p class="text-wrap">Buscador de Vacunas</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-10">
                    <div class="col-md-12 px-4 h-100 border border-dark rounded-0 overflow-auto" style="background-color: white; max-height: 357px;">
                        <p>Algo</p>
                    </div>
                </div>
            </div>
